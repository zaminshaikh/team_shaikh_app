...
import 'package:team_shaikh_app/app_services.dart' show isAuthenticated;
  ...
  Future<void> didChangeAppLifecycleState(AppLifecycleState state) async {
    ...
    if (state == AppLifecycleState.resumed) {
      ...
      print('Timer cancelled on app resume');
             ...
             await isAuthenticated() && // Called from app_services.dart
      ...
      _inactivityTimer =
          Timer(Duration(minutes: appState.selectedTimeInMinutes.toInt()), () {
      ...
      if (state != AppLifecycleState.paused &&
          state != AppLifecycleState.inactive &&
          state != AppLifecycleState.hidden) {
        print('Condition not met: AppLifecycleState is not paused/inactive/hidden');
      }
