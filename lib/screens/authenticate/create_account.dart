...
class _CreateAccountPageState extends State<CreateAccountPage> {
  ...
  final TextEditingController _createAccountEmailController =
  ...
  void _signUserUp(BuildContext context) async {
    ...
    try {
      ...
      if (!(await _databaseService.docExists(_cid))) {
        ...
        await CustomAlertDialog.showAlertDialog(context, 'Error',
      ...
      log('create_account.dart: Error signing user in: $e',
              ...
              TextButton(
                onPressed: () async {
                  ...
                  user = FirebaseAuth.instance
                      .currentUser; // Get the user object again after the delay
                  ...
                  if (user != null && user.emailVerified) {
                    ...
                    await CustomAlertDialog.showAlertDialog(
                        context, 'Success', 'Email verified successfully.',
                        icon: const Icon(Icons.check_circle_outline_rounded,
                            color: Colors.green));
                    if (!mounted) {
                      return;
                    }
                    appState = Provider.of<AuthState>(context,
                        listen: false); // Set the app state
  ...
  void handleFirebaseAuthException(
    ...
    switch (e.code) {
      case 'email-already-in-use':
        errorMessage =
            'Email $_email is already in use. Please use a different email.';
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              contentPadding: const EdgeInsets.symmetric(
                                  vertical: 14,
                                  horizontal: 14), // Padding for input content
                            ),
                        ...
                        Row(
                          children: List.generate(
                            ...
                            (index) => Container(
                              ...
                              height: 5.5,
                              margin:
                                  const EdgeInsets.symmetric(horizontal: 4.4),
                              decoration: BoxDecoration(
                                color: _passwordSecurityIndicator == 1
                        ...
                        children: [
                          ...
                          _createAccountPasswordString.length > 7
                              ? const Icon(Icons.check_rounded,
                                  size: 30,
                                  color: Color.fromARGB(255, 61, 130, 63))
                      ...
                      child: Row(
                        children: [
                          ...
                          _createAccountPasswordString.contains(RegExp(r'\d'))
                              ? const Icon(Icons.check_rounded,
                                  size: 30,
                                  color: Color.fromARGB(255, 61, 130,
                                      63)) // Green checkmark for valid condition
                              : const Icon(Icons.circle_outlined,
                                  size: 30,
                                  color: Color.fromARGB(255, 100, 116,
                                      139)), // Outlined circle for invalid condition
                          ...
                          Text(
                            ...
                            style: _passwordSecurityIndicator == 4
                                ? const TextStyle(
                                    ...
                                    color: Colors.white,
                                    fontFamily:
                                        'Titillium Web') // Style for valid condition
                                : const TextStyle(
                                    color: Color.fromARGB(255, 122, 122, 122),
                                    fontFamily:
                                        'Titillium Web'), // Style for invalid condition
                          ),
                          ...
                          TextField(
                            ...
                            onChanged: (value) {
                              setState(() {
                                ...
                                _confirmCreateAccountPasswordController.text =
                                    value;
                              });
                            },
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: _createAccountPasswordString ==
                                  _confirmCreateAccountPasswordString
                              ? const Color.fromARGB(255, 30, 75,
                                  137) // Color when passwords match
                              : const Color.fromARGB(255, 85, 86,
                                  87), // Color when passwords don't match
                          borderRadius: BorderRadius.circular(25),
                        ),
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: const TextButton(
                            onPressed:
                                null, // Set onPressed to null or add your logic inside the GestureDetector
                            child: Text(
                              'Login',
