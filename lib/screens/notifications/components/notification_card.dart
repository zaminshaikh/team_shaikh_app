...
class NotificationCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => 
    _buildNotificationWithDayHeader(context, notification, previousNotificationDate);

  Widget _buildNotificationWithDayHeader(BuildContext context, notification, DateTime previousNotificationDate) {
  ...
  Widget _buildNotification(BuildContext context, Notif notification, bool showDivider){
    String title;
    Widget route;
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            try {
                              ...
                              NewDB db = NewDB.withCID('', notification.parentCID);
