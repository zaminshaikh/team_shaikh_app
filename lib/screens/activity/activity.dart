...
class _ActivityPageState extends State<ActivityPage> {
                    ...
                    (context, index) {
                      if (index == 0) {
                        ...
                        final activity = activities[index -
                            1]; // Subtract 2 because the first index is used by the search bar and the second by the button list
                ...
                sliver: SliverList(
                  delegate: SliverChildBuilderDelegate(
                    ...
                    childCount: activities.length +
                        1, // Add 2 to include the search bar and the button list
                  ),
                ),
              ),
              const SliverToBoxAdapter(
  ...
  Widget _buildActivityWithDayHeader(Map<String, dynamic> activity, int index,
    ...
    if (previousActivityDate == null ||
      ...
      return Column(
        children: <Widget>[
          Padding(
            padding: EdgeInsets.fromLTRB(20.0, isLatestDate ? 20.0 : 40.0, 20.0,
              ...
              children: [
                Stack(alignment: Alignment.center, children: <Widget>[
                  Icon(
                    Icons.circle,
                    color:
                        getUnderlayColorBasedOnActivityType(activity['type']),
                    size: 70,
                  ),
  ...
  Widget _buildHorizontalButtonList(
          UserWithAssets user, List<UserWithAssets> connectedUsers) =>
      SizedBox(
        height: 35.0,
        child: ListView(
          ...
          children: <Widget>[
            ...
            for (var connectedUser in connectedUsers)
              Padding(
                padding:
                    const EdgeInsets.only(right: 10.0), // Add trailing padding
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.transparent,
                    side: const BorderSide(color: AppColors.defaultBlueGray100),
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: ExpansionTile(
                        title: Row(
                          children: [
                            const Text('By Type of Activity',
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.w600,
                                    fontFamily: 'Titillium Web')),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
                                Colors.white, // This is the background color
                          ),
                          child: const Text('Apply',
                              style: TextStyle(
                                  color: Color(0xFF8991A1),
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  fontFamily: 'Titillium Web')),
                          onPressed: () {
