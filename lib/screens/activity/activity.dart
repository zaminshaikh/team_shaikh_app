...
Widget _buildFilterAndSort() => Padding(
      ...
      if (userCheckStatus[activity.recipient] == true) {
        if (isFirstVisibleActivityOfTheDay) {
          return Column(
            children: <Widget>[
              Padding(
                padding: const EdgeInsets.fromLTRB(20.0, 25.0, 20.0,
                    25.0), // Add padding to the top only if it's not the latest date
                child: Align(
    ...
    setState(() {
      if (userCheckStatus.containsKey(userName)) {
        ...
        selectedUsers.remove(
            userName); // Remove the user from the list of selected users
      }
    });
  }
  ...
  void selectAllUsers() {
    setState(() {
      ...
      selectedUsers = userCheckStatus.keys
          .toList(); // Add all users to the list of selected users
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemCount:
                            3, // Increased by 2 to accommodate the title and the new ListView
                        itemBuilder: (_, index) {
                          if (index == 0) {
                            return const Center(
                              child: Padding(
                                    ...
                                    child: ExpansionTile(
                                      title: const Row(
                                        children: [
                                          ...
                                          SizedBox(
                                              width:
                                                  10), // Add some spacing between the title and the date
                                        ],
                                      ),
                            ...
                            child: ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: AppColors
                                      .defaultBlue500, // This is the background color
                                ),
                                              ...
                                              CheckboxListTile(
                                                fillColor: MaterialStateProperty
                                                  ...
                                                  if (states.contains(
                                                    ...
                                                    return AppColors
                                                        .defaultBlue500; // Color when selected
                                                  }
                                                  return Colors
                                                      .transparent; // Color when unselected
                                                }),
                                                title: const Text(
                                                  'Profit',
                                                  style: TextStyle(
                                  ...
                                  Padding(
                                      ...
                                      child: ExpansionTile(
                                        ...
                                        children:
                                          ...
                                          if (userCheckStatus[recipient] ==
                                              null) {
                                            userCheckStatus[recipient] =
                                                false; // or true, depending on your default value
                                          }
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(
                                        4.0), // Equal padding for Date Range Button
                                    child: Container(
                                      decoration: BoxDecoration(
                                        color: AppColors.defaultBlueGray700,
                                  ...
                                  if (allUsersChecked)
                                    Padding(
                                      padding: const EdgeInsets.all(
                                          4.0), // Equal padding for All Connected Users Button
                                      child: Container(
                                        decoration: BoxDecoration(
                                          color: AppColors.defaultBlueGray700,
                                          borderRadius:
                                  ...
                                  if (!allUsersChecked)
                                    Padding(
                                      padding: const EdgeInsets.all(
                                          4.0), // Equal padding for each selected user button
                                      child: Wrap(
                                        spacing: 8.0,
                                        runSpacing: 4.0,
                                  ...
                                  if (_typeFilter.contains('income') &&
                                      _typeFilter.contains('profit') &&
                                      _typeFilter.contains('deposit') &&
                                      _typeFilter.contains('withdrawal'))
                                    Padding(
                                      padding: const EdgeInsets.all(4.0),
                                      child: _buildActivityTypeButton(
                                          'All Activity Types'),
                                    ),
